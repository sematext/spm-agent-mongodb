...
function MongoDbMonitor () {
  ...
  var mongoDbUrl = SpmAgent.Config.get('mongodb.url') || ['mongodb://localhost:27017/admin']
...
var tokens = 0
if (SpmAgent.Config.get('tokesn.spm') || process.env.SPM_TOKEN || process.argv[2] && process.argv[2].length > 30) {
  tokens++
  MongoDbMonitor()
} else {
